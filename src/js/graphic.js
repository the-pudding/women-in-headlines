...
function init() {
  ...
  let logoData = [
    {
      site: "nytimes.com",
      link: "https://www.vectorlogo.zone/logos/nytimes/nytimes-icon.svg",
    },
    {
      site: "dailymail.co.uk",
      link: "https://seeklogo.com/images/D/Daily_Mail-logo-EBD7A83A1F-seeklogo.com.png",
    },
    {
      site: "cnn.com",
      link: "https://www.vectorlogo.zone/logos/cnn/cnn-icon.svg",
    }, //https://www.vectorlogo.zone/logos/cnn/cnn-wordmark.svg
    {
      site: "bbc.co.uk",
      link: "https://www.vectorlogo.zone/logos/bbc/bbc-icon.svg",
    },
    {
      site: "telegraph.co.uk",
      link: "https://upload.wikimedia.org/wikipedia/commons/4/48/The_Telegraph_logo.svg",
    },
    {
      site: "washingtonpost.com",
      link: "https://www.vectorlogo.zone/logos/washingtonpost/washingtonpost-icon.svg",
    },
    {
      site: "forbes.com",
      link: "https://www.vectorlogo.zone/logos/forbes/forbes-icon.svg",
    },
    {
      site: "abcnews.go.com",
      link: "https://www.vectorlogo.zone/logos/abcgo/abcgo-icon.svg",
    },
    {
      site: "foxnews.com",
      link: "https://www.vectorlogo.zone/logos/fox/fox-icon.svg",
    },
    { site: "ksl.com", link: "https://logodix.com/logo/2090138.png" },
    {
      site: "bloomberg.com",
      link: "https://www.vectorlogo.zone/logos/bloomberg/bloomberg-icon.svg",
    },
    {
      site: "breitbart.com",
      link: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/fe/Breitbart_News.svg/1280px-Breitbart_News.svg.png",
    },
    {
      site: "popsugar.com",
      link: "https://all-4-one.com/wp-content/uploads/2015/07/PopSugar-Logo-logo.png",
    },
    {
      site: "nbcnews.com",
      link: "https://www.vectorlogo.zone/logos/nbc/nbc-icon.svg",
    },
    {
      site: "buzzfeed.com",
      link: "https://www.vectorlogo.zone/logos/buzzfeed/buzzfeed-icon.svg",
    },
    {
      site: "cnet.com",
      link: "https://www.vectorlogo.zone/logos/cnet/cnet-icon.svg",
    },
    {
      site: "politico.com",
      link: "https://www.vectorlogo.zone/logos/politico/politico-icon.svg",
    },
    {
      site: "usatoday.com",
      link: "https://www.vectorlogo.zone/logos/usatoday/usatoday-icon.svg",
    },
    {
      site: "nydailynews.com",
      link: "https://cdn6.myket.ir/icons/large/b0f31373-17ec-46d5-b6ef-66135cc1b242_.png",
    },
    {
      site: "businessinsider.com",
      link: "https://i.insider.com/596e4e7a552be51d008b50fd?width=600&format=jpeg",
    },
    {
      site: "aajtak.in",
      link: "https://static.wikia.nocookie.net/logopedia/images/d/db/Aaj_tak.png",
    },
    ...
    {
      site: "espn.go.com",
      link: "https://cdn.worldvectorlogo.com/logos/espn.svg",
    },
    {
      site: "huffingtonpost.com",
      link: "https://www.vectorlogo.zone/logos/huffingtonpost/huffingtonpost-icon.svg",
    },
  ];
  ...
  Promise.all([
    ...
    d3.csv(
      "./assets/data/country_time_freqrank_rapi_clean_101421.csv",
      d3.autoType
    ),
  ...
  $(window).scroll(function () {
    ...
    var bottom_of_element_b =
      $(".biasCells").offset().top + $(".biasCells").outerHeight();
    ...
    var bottom_of_element_v =
      $(".crimeCells").offset().top + $(".crimeCells").outerHeight();
    ...
    var bottom_of_element_e =
      $(".empCells").offset().top + $(".empCells").outerHeight();
    ...
    var bottom_of_element_r =
      $(".raceCells").offset().top + $(".raceCells").outerHeight();
    ...
    if (
      bottom_of_screen_b > top_of_element_b &&
      top_of_screen_b < bottom_of_element_b
    ) {
      ...
      d3.selectAll("#inTextViolence").attr(
        "class",
        "stackedBarThemeAnnotation"
      );
      d3.selectAll("#inTextEmpowerment").attr(
        "class",
        "stackedBarThemeAnnotation"
      );
      d3.selectAll("#inTextRace").attr("class", "stackedBarThemeAnnotation");
      // d3.selectAll("#inTextPeople")
      //   .attr("class", "stackedBarThemeAnnotation")
      // d3.selectAll("#inTextNT")
      //   .attr("class", "stackedBarThemeAnnotation")
    } else if (
      bottom_of_screen_v > top_of_element_v &&
      top_of_screen_v < bottom_of_element_v
    ) {
      console.log("crime Section");
      d3.selectAll("#inTextViolence").attr("class", "hovered");
      d3.selectAll("#inTextBias").attr("class", "stackedBarThemeAnnotation");
      d3.selectAll("#inTextEmpowerment").attr(
        "class",
        "stackedBarThemeAnnotation"
      );
      ...
      bottom_of_screen_e > top_of_element_e &&
      top_of_screen_e < bottom_of_element_e
    ) {
      console.log("empowerment Section");
      d3.selectAll("#inTextEmpowerment").attr("class", "hovered");
      ...
      bottom_of_screen_r > top_of_element_r &&
      top_of_screen_r < bottom_of_element_r
    ) {
      console.log("race Section");
      d3.selectAll("#inTextRace").attr("class", "hovered");
  ...
  function revertOriginal(x, y, series) {
    ...
    var rectsThemes = d3
      ...
      .selectAll("rect")
      .filter(
        (d) => d.key.theme !== "No theme" && d.data.country === "All countries"
      )
      .transition()
      .duration("500")
      .ease(d3.easeLinear)
  ...
  function renderBarAxis(data, series) {
    ...
    // y axis
    yAxis = svg.append("g").call(yAxis).attr("class", "stackedChartyAxis");

    yAxis.selectAll(".tick text").remove();

    var formatValue = (x) => (isNaN(x) ? "N/A" : x.toLocaleString("en"));

    xAxis = svg.append("g").call(xAxis).attr("class", "stackedChartCountries");
    ...
    if (theme === "crime and violence") {
      ...
      d3.selectAll(".stackedBars")
        ...
        .attr("fill", (d) =>
          d.key.theme === theme
            ? color
            : d.key.theme === "crime and violence"
            ? "#f76e45"
            : "lightgrey"
        );
    } else if (theme === "EPR") {
      d3.selectAll(".stackedBars")
        .selectAll("rect")
        .attr("fill", (d) =>
          d.key.theme === "female stereotypes"
            ? "#53B67C"
            : d.key.theme === "empowerment"
            ? "#F7DC5B"
            : d.key.theme === "crime and violence"
            ? "#f76e45"
            : d.key.theme === "race, ethnicity and identity"
            ? "#F2C5D3"
            : d.key.theme === "people and places"
            ? "#5787f2"
            : "lightgrey"
        );
    }
  ...
  function activateTooltip(themes, x, y, hoverType) {
    ...
    d3.selectAll(".stackedBars")
      ...
      .on("mouseleave", (event, d) =>
        unHighlightWords(themes, d.key.word, hoverType)
      );
  }
  ...
  function highlightWords(
    ...
    d3.selectAll("." + word).attr("fill", "#E76B2D");
  ...
  function unHighlightWords(themes, word, hoverType) {
    ...
    if (hoverType === "inTextHover") {
      d3.selectAll("." + word).attr("fill", "lightgray");
    } else {
      d3.selectAll("." + word).attr("fill", (d) =>
        d.key.theme === "female stereotypes"
          ? "#53B67C"
          : d.key.theme === "empowerment"
          ? "#F7DC5B"
    ...
    d3.selectAll(".stackedBars").selectAll("rect").attr("opacity", "1");
    ...
    d3.select("#wordSearch").on("input", function () {
      ...
      if (selectedWord === "") {
        ...
        d3.selectAll(".stackedBars")
          ...
          .attr("y", (d) =>
            d.data.country === "All countries"
              ? scale(d.data[d.key.word])
              : null
          )
          // .attr("y",100)
          // .text(d=> d.key.word)
  ...
  function drawBarLegend() {
    ...
    legendLine = svg
      ...
      .selectAll("line")
      .data([
        { x1: 0, x2: 185, y1: 28, y2: 28 },
        { x1: 0, x2: 0, y1: 28, y2: 20 },
        { x1: 185, x2: 185, y1: 28, y2: 20 },
      ])
      .join("line")
      .attr("x1", (d) => d.x1)
      .attr("x2", (d) => d.x2)
  ...
  function drawBar(countries_data, chart, selected_country, word_count) {
    ...
    data = [
      {
        ...
        data: countries_data.filter((d) => d.country == selected_country),
      },
      {
        country: "USA",
        data: countries_data.filter((d) => d.country == selected_country),
    ...
    dataBars = dataBars.sort(function (a, b) {
      return d3.descending(+a.frequency, +b.frequency);
    });
    //console.log(dataBars)

    top10 = dataBars.filter(function (d, i) {
      return i < word_count;
    });
    console.log(top10);
    ...
    flags = [
      ...
      { country: "India", flag: "assets/images/flags/india.svg" },
      { country: "UK", flag: "assets/images/flags/united-kingdom.svg" },
      { country: "All", flag: "None" },
    ];

    countryNames = [
      { country: "South Africa", name: "South Africa" },
      { country: "USA", name: "United States" },
      { country: "India", name: "India" },
      { country: "UK", name: "United Kingdom" },
      { country: "All", name: "All 4 countries" },
    ];
    ...
    svg
      ...
      .attr(
        "xlink:href",
        flags.filter((c) => c.country === selected_country)[0]["flag"]
      );
    ...
    svg
      ...
      .text(
        countryNames.filter((c) => c.country === selected_country)[0]["name"]
      )
  ...
  function renderLollipop(data) {
    ...
    data = data.sort((a, b) =>
      d3.descending(+a.polarity_women, +b.polarity_women)
    );
    ...
    lollipopChart
      ...
      .join("line")
      .attr("x1", function (d) {
        return x(d.polarity_base);
      })
      .attr("x2", function (d) {
        return x(d.polarity_women);
      })
      .attr("y1", function (d) {
        return y(d.site_clean);
      })
    ...
    lollipopChart
      ...
      .text((d) =>
        ((d.polarity_women - d.polarity_base) / d.polarity_base) * 100 > 0
          ? "+" +
            Math.round(
              ((d.polarity_women - d.polarity_base) / d.polarity_base) * 100
            ) +
            "%"
          : Math.round(
              ((d.polarity_women - d.polarity_base) / d.polarity_base) * 100
    ...
    d3.select("#sortLollipopDiff").on("click", function () {
      // reorder site names
      // var dataSort = data.sort((a,b)=> d3.descending(+a.difference, +b.difference))
      var dataSort = data.sort((a, b) =>
        d3.descending(
          +((a.polarity_women - a.polarity_base) / a.polarity_base),
          +((b.polarity_women - b.polarity_base) / b.polarity_base)
        )
      );
      ...
      // sort the circles
      lollipopChart
        .selectAll("circle") //.attr("r", 20)//the bars were added before
        ...
        .attr(
          "cy",
          (d, i) => (d !== undefined ? y(d.site_clean) : "-60") //xScale is defined earlier
        );
      // sort the annotations
      lollipopChart
        .selectAll(".polarityDiffAnnotation") //.attr("r", 20)//the bars were added before
        // .data(data.sort((a,b)=> d3.descending(+a.difference, +b.difference)))
        .sort((a, b) =>
          d3.descending(
            +((a.polarity_women - a.polarity_base) / a.polarity_base),
      ...
      // sort the lines
      lollipopChart
        .selectAll(".polarityCompBubbleLine") //.attr("r", 20)//the bars were added before
        // .data(data.sort((a,b)=> d3.descending(+a.difference, +b.difference)))
        .sort((a, b) =>
          d3.descending(
            +((a.polarity_women - a.polarity_base) / a.polarity_base),
    ...
    d3.select("#sortLollipopPol").on("click", function () {
      // reorder site names
      var dataSort = data.sort((a, b) =>
        d3.descending(+a.polarity_women, +b.polarity_women)
      );
      ...
      lollipopChart
        ...
        .sort((a, b) =>
          a !== undefined
            ? d3.ascending(+a.polarity_women, +b.polarity_women)
            : ""
        )
        .transition()
        .duration("1000")
  ...
  function renderTimeSeries(data) {
    ...
    data = mapToArray(
      d3.rollup(
        data,
        (v) => [
          d3.median(v, (d) => d.women_polarity_median),
          d3.median(v, (d) => d.all_polarity_median),
        ],
        (d) => d.year
      )
    ).filter((d) => d.year !== 2021 && d.year !== 2016);
    console.log("sent comp", data);
    ...
    const y = d3
      .scaleLinear()
      .domain([0, d3.max(data, (d) => d.womenPolarityMed)])
      .nice()
      .range([height - margin.bottom, margin.top]);
  ...
  function renderTempChart(dataset, filter, country, variable, headlines) {
    ...
    var words = dataset.filter(
      (d) =>
        d.year > filter[0] &&
        d.year < filter[1] &&
        d.country === country &&
        d.theme !== "people and places" &&
        d.theme !== "important people" &&
        d.theme !== "No theme" &&
        !removeWords.includes(d.word)
    );
    ...
    // grid data
    var grid = d3.cross(d3.range(rows), d3.range(cols), (row, col) => ({
      row,
      col,
    }));
    ...
    // people and places
    var linearGradientP = defs
      .append("linearGradient")
      .attr("id", "linear-gradient-P");
    linearGradientP
      .attr("x1", "0%")
      .attr("y1", "0%")
      .attr("x2", "0%")
    ...
    // no theme
    var linearGradientNT = defs
      .append("linearGradient")
      .attr("id", "linear-gradient-NT");
    linearGradientNT
      .attr("x1", "0%")
      .attr("y1", "0%")
      .attr("x2", "0%")
    ...
    const cells = g
      ...
      // .attr('class', 'cell')
      .attr("class", (d) =>
        words.filter((c) => c.word === d.word)[0].theme === "female stereotypes"
          ? "biasCells"
          : words.filter((c) => c.word === d.word)[0].theme === "empowerment"
          ? "empCells"
    ...
    const themesNames = [
      { name: "Crime and Violence", id: "inTextViolence", width: "150px" },
      ...
      {
        name: "Race, Ethnicity and Identity",
        id: "inTextRace",
        width: "200px",
      },
    ];
    ...
    stickyAxis
      ...
      .call((g) =>
        g.select(".domain").attr("stroke-width", 2).attr("color", "#282828")
      ); //.attr("color", "grey")
    // .call(g => g.select('.domain').remove())
    ...
    const circles = circleEvents
      ...
      .attr("opacity", "0.5")
      .on("mouseover", (event, d) =>
        timeRuler(event, d.data, g, svg, col, minDate, maxDate, visHeight, x)
      )
      .on("mouseleave", (event, d) => {
  ...
  function timeRuler(event, d, g, svg, col, minDate, maxDate, visHeight, x) {
    ...
    tooltip
      ...
      .html(
        `<span class="datettip">${d3.timeFormat("%b %Y")(d.date)}</span><br>
					<i>${d.name}`
      )
  ...
  function showTooltipHeadlineMatch(coords, data, word) {
    ...
    let hlDate = tooltipHeadline
      ...
      .html(
        "<span class='datettip'>" +
          d3.timeFormat("%b %Y")(new Date(data[randHeadline].time)) +
          " | " +
          data[randHeadline].site +
          "</span>"
      )
    ...
    let headlineWords = data[randHeadline].headline_no_site
      .split(" ")
      .map((d) => (d.match(word) ? `<b>${d}</b>` : d));
  ...
  function showTooltipHeadline(
    ...
    data =
      c.bias > 0.5 &&
      data.filter((d) => (d.site === text1) & (d.bias > 0.5)).length > 10
        ? data.filter((d) => (d.site === text1) & (d.bias > 0.5))
        : c.bias < 0.5 &&
          data.filter((d) => (d.site === text1) & (d.bias < 0.5)).length > 10
        ? data.filter((d) => (d.site === text1) & (d.bias < 0.5))
  ...
  function drawBubbleChart(data, headlines, chart, variable) {
    ...
    var xScale = d3
      ...
      .domain(
        variable === "polarity"
          ? [0, d3.max(filterData, (d) => +d[variable])]
    ...
    var radius = d3.scaleSqrt().domain(extentvisits).range([3, 70]);

    // create linear scale for logo size
    var logoScale = d3.scaleLinear().domain(extentvisits).range([18, 100]);
      ...
      .on("tick", function () {
        ...
        var newLogos = logos
          ...
          .attr("transform", (d) =>
            d.site == "bbc.co.uk"
              ? "translate(-50,-50)"
              : (d.site == "cnn.com") | (d.site == "foxnews.com")
              ? "translate(-30,-30)"
              : d.site == "espn.go.com"
              ? "translate(-34,-10)"
              : (d.site == "nytimes.com") | (d.site == "buzzfeed.com")
              ? "translate(-25,-25)"
              : (d.site == "washingtonpost.com") |
                (d.site == "huffingtonpost.com") |
                (d.site == "usatoday.com")
              ? "translate(-20,-20)"
              : d.site == "dailymail.co.uk"
              ? "translate(-22,-18)"
              : (d.site == "politico.com") |
                (d.site == "ksl.com") |
                (d.site == "abcnews.go.com") |
                (d.site == "nydailynews.com")
              ? "translate(-12.5,-12.5)"
              : d.site == "telegraph.co.uk"
              ? "translate(-15,-3)"
              : d.site == "breitbart.com"
              ? "translate(-14,-10)"
              : d.site == "aajtak.in"
              ? "translate(-25,-20)"
              : d.site == "businessinsider.com"
              ? "translate(-14,-13)"
              : "translate(-15,-15)"
          )
          .attr("width", (d) => logoScale(+d.monthly_visits))
          .attr("xlink:href", (d) =>
            +d.monthly_visits > 150000000
              ? logoData.filter((x) => x.site == d.site)[0]["link"]
              : ""
          )
          .on("mouseenter", (event, d) => {
            showTooltipHeadline(
    ...
    var legendData = [
      {
        ...
        x: bodywidth5 / 2.2,
        anchor: "end",
        xtext: bodywidth5 / 2.235,
        ytext: bodyheight5 + 53,
        id: "",
      },
      {
        level: "",
      ...
      },
      {
        ...
        x: bodywidth5 / 1.85,
        anchor: "middle",
        xtext: bodywidth5 / 1.85,
        ytext: bodyheight5 + 46,
        id: "",
      },
      {
        level: "?",
        radius: radius(30000000),
        y: bodyheight5 * 1.08 + 11,
        x: bodywidth5 + 15,
        anchor: "middle",
        xtext: bodywidth5 + 15,
        ytext: bodyheight5 * 1.08 + 16,
        id: "info",
      },
    ];
    ...
    var legend = chart
      ...
      .on("mouseover", (event, d) =>
        d.id === "info"
          ? tooltipInfo(event.clientX - 150, event.clientY - 420)
          : ""
      )
      .on("mouseleave", (event, d) =>
    ...
    d3.select("#pubdropdown").on("change", function () {
      ...
      // circles.style("stroke-width", d=>d.country_of_pub.toLowerCase() === selection.toLowerCase()?"2px":"0.6px")
      allCircs.style("fill", (d) =>
        d.site.toLowerCase() === selection.toLowerCase() ? "#F7DC5B" : "#FEFAF1"
      );
      allCircs.style("opacity", (d) =>
  ...
  function drawWordClusters(data) {
    ...
    groups = {
      "South Africa, male": {
        ...
        pc_freq:
          d3.sum(
            data.filter((d) => d.cluster === "South Africa, male"),
            (d) => +d.frequency
          ) / d3.sum(data, (d) => d.frequency),
      },
      "South Africa, violence": {
        ...
        pc_freq:
          d3.sum(
            data.filter((d) => d.cluster === "South Africa, violence"),
            (d) => +d.frequency
          ) / d3.sum(data, (d) => d.frequency),
      },
      "South Africa, female": {
        ...
        pc_freq:
          d3.sum(
            data.filter((d) => d.cluster === "South Africa, female"),
            (d) => +d.frequency
          ) / d3.sum(data, (d) => d.frequency),
      },
      "South Africa, empowerment": {
        x: width5 - 1200,
        y: height5,
        color: "lightblue",
        country: "South Africa",
        pc_freq:
          d3.sum(
            data.filter((d) => d.cluster === "South Africa, empowerment"),
            (d) => +d.frequency
          ) / d3.sum(data, (d) => d.frequency),
      },
      ...
      "USA, male": {
        ...
        pc_freq:
          d3.sum(
            data.filter((d) => d.cluster === "USA, male"),
            (d) => +d.frequency
          ) / d3.sum(data, (d) => d.frequency),
      },
      "USA, violence": {
        ...
        pc_freq:
          d3.sum(
            data.filter((d) => d.cluster === "USA, violence"),
            (d) => +d.frequency
          ) / d3.sum(data, (d) => d.frequency),
      },
      "USA, female": {
        ...
        pc_freq:
          d3.sum(
            data.filter((d) => d.cluster === "USA, female"),
            (d) => +d.frequency
          ) / d3.sum(data, (d) => d.frequency),
      },
      "USA, empowerment": {
        ...
        pc_freq:
          d3.sum(
            data.filter((d) => d.cluster === "USA, empowerment"),
            (d) => +d.frequency
          ) / d3.sum(data, (d) => d.frequency),
      },
      ...
      "UK, male": {
        ...
        pc_freq:
          d3.sum(
            data.filter((d) => d.cluster === "UK, male"),
            (d) => +d.frequency
          ) / d3.sum(data, (d) => d.frequency),
      },
      "UK, violence": {
        ...
        pc_freq:
          d3.sum(
            data.filter((d) => d.cluster === "UK, violence"),
            (d) => +d.frequency
          ) / d3.sum(data, (d) => d.frequency),
      },
      "UK, female": {
        ...
        pc_freq:
          d3.sum(
            data.filter((d) => d.cluster === "UK, female"),
            (d) => +d.frequency
          ) / d3.sum(data, (d) => d.frequency),
      },
      "UK, empowerment": {
        ...
        pc_freq:
          d3.sum(
            data.filter((d) => d.cluster === "UK, empowerment"),
            (d) => +d.frequency
          ) / d3.sum(data, (d) => d.frequency),
      },
      ...
      "India, male": {
        ...
        y: height5 - 480,
        color: "#93D1BA",
        theme: "Male Dominance",
        pc_freq:
          d3.sum(
            data.filter((d) => d.cluster === "India, male"),
            (d) => +d.frequency
          ) / d3.sum(data, (d) => d.frequency),
      },
      "India, violence": {
        ...
        pc_freq:
          d3.sum(
            data.filter((d) => d.cluster === "India, violence"),
            (d) => +d.frequency
          ) / d3.sum(data, (d) => d.frequency),
      },
      "India, female": {
        ...
        y: height5 - 480,
        color: "#79BACE",
        theme: "Women Stereotypes",
        pc_freq:
          d3.sum(
            data.filter((d) => d.cluster === "India, female"),
            (d) => +d.frequency
          ) / d3.sum(data, (d) => d.frequency),
      },
      "India, empowerment": {
        ...
        pc_freq:
          d3.sum(
            data.filter((d) => d.cluster === "India, empowerment"),
            (d) => +d.frequency
          ) / d3.sum(data, (d) => d.frequency),
      },
    };
    ...
    clusterColors = d3
      .scaleSequential(d3.interpolateLab("lightgrey", "#F52D4F"))
      .domain([0.015, 0.14]);

    // create radial scale for size of bubbles
    extentWordFreq = d3.extent(data, (d) => +d.perc_freq);
    var bubbleRadius = d3.scaleSqrt().domain(extentWordFreq).range([2, 10]);
              ...
              do {
                if (q.data !== d) {
                  const r =
                    d.radius +
                    q.data.radius +
                    (d.clusterName === q.data.clusterName
                      ? padding1
                      : padding2);
                  let x = d.x - q.data.x,
                    y = d.y - q.data.y,
  ...
  function drawNetwork(data, network, country, bars, svgID) {
    ...
    var nodeOpacity = d3.scaleLinear().domain(extentWordFreq).range([0.2, 1]);
    // scale for text opacity
    var textOpacity = d3.scaleLinear().domain(extentWordFreq).range([0.4, 1]);
    // scale for font size of text
    var fontScale = d3.scaleLinear().domain(extentWordFreq).range([1, 20]);
